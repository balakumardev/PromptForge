...
class PromptForgeSettings : PersistentStateComponent<PromptForgeSettings.State> {
    ...
    companion object {
        val DEFAULT_COMPLETE_TEST_CLASS_PROMPT = """Your task is to write a complete JUnit 5 test class for {CLASS_NAME}.
...
12. Use assertThrows() to test exception scenarios.
...
DO NOT include any explanations, comments, or anything other than the Java code itself.
Begin the Java file content immediately, starting with the package or import statements.
"""

        val DEFAULT_TEST_METHODS_FOR_CHANGES_PROMPT = """I'll provide you with:
